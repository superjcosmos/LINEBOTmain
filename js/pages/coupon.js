  ...
  return '' +
    '<div style="display:flex;align-items:center;gap:8px;position:relative;">' +
      ...
      '<button type="button" onclick="toggleCouponInfoTip(event)" title="功能說明" ' +
        'style="width:22px;height:22px;border-radius:50%;border:1.5px solid #06c755;background:#fff;color:#06c755;font-size:13px;font-weight:bold;cursor:pointer;line-height:1;padding:0;">ⓘ</button>' +
